    ...
    <div className="pt-[40px] pb-[100px]">
      <div className="container px-4">
        <div className="flex flex-col gap-[50px]">
          <div>
            <h1 className="text-[28px] md:text-[32px] font-[700] leading-snug">
            ...
            <div className="flex flex-col gap-[30px] w-full lg:w-[40%]">
              {[
                ...
                <div key={i} className="flex items-start gap-[20px]">
                  <img src={item.img} alt="" className="w-[60px] h-[60px] object-contain" />
                  <div className="flex flex-col gap-[8px] w-full">
                    <h4 className="text-[18px] md:text-[20px] font-[700] leading-tight">
                      <span className="text-[#5db3ef] mr-1">{item.step}</span> {item.title}
                    </h4>
