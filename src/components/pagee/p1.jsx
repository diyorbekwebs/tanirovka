      ...
      <div className="bg-white text-black p-6 space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border p-4 rounded-xl shadow space-y-2">
            <h3 className="text-xl font-semibold text-red-600">📍 Toshkent shahri – Sergeli bozor</h3>
            <p>👤 Omonjon</p>
        ...
        {/* Fargʻona vodiysi */}
        <div className="border p-4 rounded-xl shadow space-y-2">
          <h3 className="text-xl font-semibold text-red-600">📍 Fargʻona, Andijon, Namangan</h3>
          <p>👤 Oybekjon</p>
        ...
        <div className="border p-4 rounded-xl shadow space-y-4">
          <h3 className="text-xl font-semibold text-green-700">🧰 Tanirovka / Detailing – Toshkent</h3>
